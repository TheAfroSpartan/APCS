...
public class MagPie4
{
    ...
    public String getResponse(String statement)
    {
        ...
        else if (findKeyword(statement, "I want to", 0) >= 0)
        {
        	...
        	int position = findKeyword(statement, "I", 0);
        	 ...
        	 if (position >= 0 && findKeyword(statement, "you", position) >= 0)
             {
    ...
    private String transformIWantStatement(String statement)
    {
        ...
        String restOfStatement = statement.substring(position + 7).trim();
    ...
    private String transformIYouStatement(String statement)
    {
        ...
        int positionOfMe = findKeyword (statement, "you", positionOfYou + 2);

        String restOfStatement = statement.substring(positionOfYou + 2, positionOfMe).trim();
    ...
    private String getRandomResponse()
    {
        ...
        responses[4] = "Really?";
        responses[5] = "That is rather odd.";
