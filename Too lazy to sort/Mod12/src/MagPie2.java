...
public class MagPie2
{
    ...
    public String getResponse(String statement)
    {
                ...
                || statement.indexOf("brother") >= 0)
        {
        	...
        	response = "They sound like a nice person.";
        ...
        {
        	response = "Describe a color?";
        }
        else if(statement.indexOf("like") >= 0)
        {
        	response = "I like that as well!";
        }
        ...
        else if(findKeyword(statement, "day", 0) >=0) {
        	response = "It is a nice day";
        }
