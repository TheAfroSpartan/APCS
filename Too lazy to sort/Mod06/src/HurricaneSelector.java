...
public class HurricaneSelector {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		PrintWriter outFile6 = new PrintWriter(new File ("summary.txt"));
...
*/
		...
		//loop for average
		 ...
		 outFile6.print("\t");
		 outFile6.printf("%-9s\t","Average:");
		 outFile6.printf("%6.1f\t\t", catAverage);
		 outFile6.printf("%7.1f\t\t", pressureAverage);
		 outFile6.printf("%6.2f%n", windAverage);
		 outFile6.printf("\t");
		 outFile6.printf("%-9s\t","Minimum:");
		 outFile6.printf("%4s\t\t", min);
		 outFile6.printf("%5s\t\t", min2);
		 outFile6.printf("%5.2f%n", min1 * 1.15078);
		 outFile6.printf("\t");
		 outFile6.printf("%-9s\t","Maximum:");
		 outFile6.printf("%4s\t\t", max);
		 outFile6.printf("%5s\t\t", max2);
		 outFile6.printf("%5.2f%n", max1 * 1.15078);
		 outFile6.println("\tCat 1: " + counter1);
		 outFile6.println("\tCat 2: " + counter2);
		 outFile6.println("\tCat 3: " + counter3);
		 outFile6.println("\tCat 4: " + counter4);
		 outFile6.println("\tCat 5: " + counter5); 
		 outFile6.close();
