...
public class GradeBook {
	...
	//Method to Print out the array elements
		 ...
		 * @param find
		 */
	    public static void changeStudent(ArrayList<Student> students, String find, String replace)
	    {
	        int location = 0;
	        int index;
	        ...
	        if (index != students.size())
	            students.get(location).setName(replace);
	    }
		
    public static void changeScore(ArrayList<Student> students, String find, int testNum, int score){
        ...
        int location = 0;
	        ...
	        if (index != students.size())
	            students.get(location).setScore(testNum, score);
	    }
}
