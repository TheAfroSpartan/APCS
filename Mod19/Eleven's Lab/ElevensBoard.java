...
public class ElevensBoard extends Board
{
    ...
    * a , a queen, and a king in some order.
    ...
    * of three cards consisting of a , a queen, and a king in some order.
   ...
   public boolean anotherPlayIsPossible() {
      /* *** TO BE IMPLEMENTED IN ACTIVITY 9 *** */
       ...
       if(containsPairSum11(k) || containsJQK(k))
           return true;
      ...
      /* *** TO BE IMPLEMENTED IN ACTIVITY 9 *** */
	   for(Integer k : selectedCards)
           for(Integer j : selectedCards)
               if(cardAt(k).pointValue() + cardAt(k).pointValue() == 11)
                   return true;
    ...
    *                      to find a JQK group.
    * @return true if the board entries in selectedCards
    *              include a , a queen, and a king; false otherwise.
    */
